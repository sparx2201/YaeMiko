...
from Mikobot import DEMONS, DEV_USERS, DRAGONS, LOGGER, OWNER_ID, WOLVES, TIGERS, function
...
async def botstaff(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reply += "\n\n◊ <b>WOLVES :</b>\n"
    reply += ("\n".join(await get_users_list(context, WOLVES)) or "No additional whitelisted users")

    reply += "\n\n‣ <b> 𝘊𝘩𝘦𝘤𝘬 𝘠𝘰𝘶𝘳 </b> <a href=https://telegra.ph/Disaster-Levels-04-11> 𝘋𝘪𝘴𝘢𝘴𝘵𝘦𝘳 𝘓𝘦𝘷𝘦𝘭</a> \n"
