...
async def generate_image(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = f"*<b>Generated By:</b> {user.user.first_name} (<a href='tg://user?id={user.user.id}'>{user.user.username}</a>)\n<b>Powered By:</b> @JinX_UBot\n<b>Prompt:</b> `{prompt}`"
#
    try:
        await context.bot.send_photo(chat_id=message.chat_id, photo=file_path, caption=caption, parse_mode=ParseMode.MARKDOWN)
