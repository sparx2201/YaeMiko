    ...
    if response.status_code == 200:
            try:
                if response.json():
                    ...
                    await message.reply_photo(photo=response.content, caption=f"**Generated By** : {user.mention()}\n**Powered By** : @JinX_UBot\n**Prompt** : `{prompt}`")
                else:
...
#                await message.reply_photo(response.content, caption=f"**Generated By** : {user.mention()}\n**Powered By** : @JinX_UBot\n**Prompt** : `{prompt}`")
#                print("Send the generated image")
